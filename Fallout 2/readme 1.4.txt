                ...
                FALLOUT 2: A Post-Nuclear Role-Playing Game
                     Readme File 1.4 - 29 January 1999
                               Patch Version 1.02d
...
(1.0) Patch
-----------
The patch will invalidate saved games from version 1.0. 

This is the Patch for the 1.0 *US* Version only. If your version
is 1.01 then you have the UK or the english low violence version.

The US version was sold in many other countries: Germany,
Australia, France, etc. If it's in english and it's version 1.0
then it's the US version. 

If you have saved game from an early beta patch, the Final US patch
IS  compatible with those saved games. The Beta patch was just that, a
Beta, so if you were having problems with your saved games with the
Beta patch, we recommend that you completely start over.

Other Versions: If you have the French or German version, you will
need the French or German patch. If you have the low violence english
version, you will need the low violence english patch.

The UK version has a Gold CD. The box is also completely different
than the US version shown on the Fallout 2 home page. The UK version:
1. The number 2, of Fallout 2,is set in the middle of a gold sphere.
2. The bottom of the box, in the lower right corner is a symbol with
the letters "USK."
3. The UK version also has Full violence levels and the language
filter can be turned on and off.

Contact the US or UK Customer Service if you are uncertain if you
have the US or UK version. Applying the wrong patch will corrupt
portions of the game. Be sure you do not apply this patch if you
have the low violence english version.

Be sure to check (1.4) README CHANGES for a list of modified sections
of this readme from version 1.0.
